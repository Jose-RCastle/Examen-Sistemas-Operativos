...
- Segunda oportunidad con la convención del curso: carga con R=0 y un acierto cambia R a 1.
- Ejemplo Óptimo de OSTEP: 5 fallos y el desempate explícito de páginas sin uso futuro.
- NRU: prioridad de las cuatro clases, conservación de M, opción de que cada fallo ponga M=1, límites exactos de reinicio, convenciones de desempate y reproducción con semilla.
...
- 120 cadenas de 40 referencias: invariantes en los seis algoritmos y comparación con Óptimo.
...
En la comprobación local pasan 23 pruebas del motor. La revisión visual local requiere Chromium con Playwright. El repositorio incluye un trabajo separado de GitHub Actions para ejecutar la prueba real de interfaz; su resultado aparece en la pestaña Actions.
